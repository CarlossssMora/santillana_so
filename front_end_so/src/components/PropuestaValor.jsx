    ...
    return (
        <section
            ...
            <div className="max-w-7xl mx-auto px-4 text-center text-white">
                {/* Título */}
                <h2 className="text-4xl font-bold mb-6">Propuesta de Valor</h2>
                {/* Texto principal */}
                <p className="text-lg leading-relaxed max-w-3xl mx-auto mb-12">
                ¿Qué diferencia a <span className="font-bold">SANTILLANA CONSULTORES</span>? 
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-xl font-bold mb-2">Resultados Medibles</h3>
                    <p className="text-sm">
                ...
                <div className="flex flex-col items-center">
                    <FaCheckCircle className="text-6xl mb-4" />
                    <h3 className="text-xl font-bold mb-2">Estrategias Personalizadas</h3>
                    <p className="text-sm">
                ...
                <div className="flex flex-col items-center">
                    <FaCheckCircle className="text-6xl mb-4" />
                    <h3 className="text-xl font-bold mb-2">Innovación Continua</h3>
                    <p className="text-sm">
