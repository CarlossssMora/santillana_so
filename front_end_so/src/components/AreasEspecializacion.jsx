      ...
      <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {areas.map((area, index) => (
            <div
              key={index}
              className="bg-white rounded-lg shadow-lg p-6 text-left flex flex-col items-center md:items-start"
            >
              <div className="mb-4">{area.icon}</div>
              <h4 className="text-xl font-bold text-gray-800 mb-2">{area.title}</h4>
